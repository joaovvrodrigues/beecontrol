          ...
          children: [
              ...
              child: Row(
                children: [
                  Padding(
                    ...
                    child:
                        Icon(Ionicons.home, size: 15, color: AppTheme.eclipse),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: CustomFormField(
                      ...
                      textCapitalization: TextCapitalization.words,
                      onSaved: (text) => user = user.copyWith(city: text),
                      validator: (text) {
                        if (text == null || text.isEmpty) {
                          return 'Este campo é obrigatório';
                        }
            ...
            Padding(
              ...
              child: CustomFormField(
                ...
                textCapitalization: TextCapitalization.words,
                onSaved: (text) => user = user.copyWith(street: text),
                validator: (text) {
                  if (text == null || text.isEmpty) {
                    return 'Este campo é obrigatório';
                  }
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: CustomFormField(
                      ...
                      icon: Ionicons.home_outline,
                      textCapitalization: TextCapitalization.words,
                      onSaved: (text) => user = user.copyWith(district: text),
                      validator: (text) {
                        if (text == null || text.isEmpty) {
                          return 'Este campo é obrigatório';
                        }
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: CustomFormField(
                      ...
                      onSaved: (text) =>
                          user = user.copyWith(number: int.parse(text!)),
                      validator: (text) {
                        if (text == null || text.isEmpty) {
                          return 'Este campo é obrigatório';
                        }
              ...
              child: Column(
                children: [
                  ...
                  CheckboxListTile(
                    value: true,
                    onChanged: (value) {},
                    title: Text('Desejo receber notícias pelo e-mail'),
                    checkColor: AppTheme.eclipse,
                  ),
                ],
              ),
